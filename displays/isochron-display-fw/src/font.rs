//! 6x8 Bitmap Font
//!
//! Compact font for OLED displays. Each character is 6 pixels wide
//! and 8 pixels tall, stored as 6 bytes (one byte per column).
//!
//! Covers ASCII printable characters (32-127).

/// 6x8 font data for ASCII 32-127 (96 characters)
/// Each character is 6 bytes, one per column, LSB at top
pub static FONT_6X8: [[u8; 6]; 96] = [
    ...
    [0x08, 0x1C, 0x2A, 0x08, 0x08, 0x00], // 127 DEL (arrow)
];
